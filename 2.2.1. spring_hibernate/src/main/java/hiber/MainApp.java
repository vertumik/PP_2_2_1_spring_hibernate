...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carService.add(new Car("auto", "1"));
      carService.add(new Car("auto", "2"));
      carService.add(new Car("auto", "3"));
      carService.add(new Car("auto", "4"));
      ...
      System.out.println("Найти \"auto 2\"");
      System.out.println(userService.findOwner("auto", "2"));
      context.close();
   }
}
